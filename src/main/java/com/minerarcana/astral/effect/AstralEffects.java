...
public class AstralEffects {
    public static DeferredRegister<MobEffect> EFFECTS = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, Astral.MOD_ID);

    public static RegistryObject<MobEffect> ASTRAL_TRAVEL = EFFECTS.register("astral_travel", () -> new AstralTravelEffect()
