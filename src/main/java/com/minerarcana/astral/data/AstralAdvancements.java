...
public class AstralAdvancements extends AdvancementProvider {
    ...
    private void registerAdvancements(Consumer<Advancement> consumer) {
        ...
        innerRealm = Advancement.Builder.advancement()
                ...
                .display(new DisplayBuilder(AstralItems.KEY_OF_ENLIGHTENMENT.get(), "withdrawal").build())
                .rewards(enlightenmentKeyReward)
                .save(consumer, new ResourceLocation(Astral.MOD_ID, "withdrawal").toString());

        magicalPuissance = Advancement.Builder.advancement()
                .parent(innerRealm)
                .addCriterion("none", ChangeDimensionTrigger.TriggerInstance.changedDimensionTo(AstralDimensions.INNER_REALM))
        ...
        enterStronghold = Advancement.Builder.advancement()
                .parent(magicalPuissance)
                .addCriterion("seeing_through_other_eyes", PlayerTrigger.TriggerInstance.located(LocationPredicate.inStructure(BuiltinStructures.STRONGHOLD)))
...
//                .parent(becomeAstral)
//                .addCriterion("use_etheric_powder", InventoryChangeTrigger.TriggerInstance.forItems(AstralItems.ETHERIC_POWDER_ITEM.get()))
...
//
        etherealHunter = Advancement.Builder.advancement()
                ...
                .addCriterion("kill_spiritual", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(AstralTags.ATTUNED_MOBS)))
        ...
        Consumer<Advancement> consumer = (advancement) -> {
            if (!set.add(advancement.getId())) {
                ...
                try {
                    ...
                    Astral.LOGGER.error("Couldn't save advancement {}", path, ioexception);
                }
            }
        };
