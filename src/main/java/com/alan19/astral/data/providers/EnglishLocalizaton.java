...
public class EnglishLocalizaton extends LanguageProvider {
    ...
    private void addBlocks() {
        ...
        add(CYAN_CYST.get(), "Cyan Cyst");
        add(LARGE_CYAN_CYST.get(), "Large Cyan Cyst");
        add(CYAN_SWARD.get(), "Cyan Sward");
        add(TALL_CYAN_SWARD.get(), "Tall Cyan Sward");
        add(CYAN_BELLEVINE.get(), "Cyan Bellevine");
        add(CYAN_BLISTERWART.get(), "Cyan Blisterwart");
        add(CYAN_KLORID.get(), "Cyan Klorid");
        add(CYAN_MORKEL.get(), "Cyan Morkel");
        add(CYAN_PODS.get(), "Cyan Pods");
    ...
    private void addItems() {
        ...
        add(CYAN_CYST_ITEM.get(), "Cyan Cyst");
        add(LARGE_CYAN_CYST_ITEM.get(), "Large Cyan Cyst");
        add(CYAN_SWARD_ITEM.get(), "Cyan Sward");
        add(TALL_CYAN_SWARD_ITEM.get(), "Tall Cyan Sward");
        add(CYAN_BELLEVINE_ITEM.get(), "Cyan Bellevine");
        add(CYAN_BLISTERWART_ITEM.get(), "Cyan Blisterwart");
        add(CYAN_KLORID_ITEM.get(), "Cyan Klorid");
        add(CYAN_MORKEL_ITEM.get(), "Cyan Morkel");
        add(CYAN_PODS_ITEM.get(), "Cyan Pods");
