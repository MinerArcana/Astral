...
public class ItemTagGenerator extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        getBuilder(AstralTags.ASTRAL_PICKUP).add(etherealItems).add(ENLIGHTENMENT_KEY.get(), ETHERIC_POWDER_ITEM.get(), PHANTOM_EDGE.get(), PHANTASMAL_AXE.get(), PHANTASMAL_PICKAXE.get(), PHANTASMAL_SHOVEL.get(), PHANTASMAL_SWORD.get(), SLEEPLESS_EYE.get(), METAPHORIC_BONE.get(), PHANTASMAL_SHEARS.get(), METAPHORIC_FLESH.get(), DREAMWEAVE.get(), DREAMCORD.get());
