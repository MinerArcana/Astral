...
public class AstralFeatures {
    ...
    public static final RegistryObject<AstralIslandStructure> ASTRAL_ISLAND = FEATURES.register("astral_island_structure", () -> new AstralIslandStructure(EthericIslesConfig::deserialize));
