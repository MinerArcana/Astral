...
@OnlyIn(Dist.CLIENT)
public class EtherealMobSpawnerRenderer extends BlockEntityRenderer<EtherealMobSpawnerTileEntity> {
    public EtherealMobSpawnerRenderer(BlockEntityRenderDispatcher p_i226016_1_) {
        super(p_i226016_1_);
    }

    @Override
    @ParametersAreNonnullByDefault
    public void render(EtherealMobSpawnerTileEntity tileEntityIn, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
