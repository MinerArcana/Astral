...
public class StrippedEtherealWood extends RotatedPillarBlock implements Ethereal {
    public StrippedEtherealWood() {
        super(Block.Properties.create(Material.WOOD, MaterialColor.SAND).hardnessAndResistance(2.0F).sound(SoundType.WOOD).notSolid());
    }
